...
'use strict';
import { OIDC_DEFAULT_SCOPES, invokeAsync, PerformanceEvents, UrlString, ThrottlingUtils, ProtocolUtils, AuthError, ProtocolMode, ServerResponseType, Constants } from '@azure/msal-common';
